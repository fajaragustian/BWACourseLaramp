...
@section('title','Dashboard New Discount ')
@section('content')
<!-- Page Heading -->
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">New Code Discount Event</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form class="user" method="POST" action="{{ route('discounts.store') }}">
                            @csrf
                            {{-- Name --}}
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Create Your Discounts" value="{{ old('name') }}">
                                @error('name')
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Create Your Code Discount" value="{{ old('code') }}">
                                @error('code')
                                <span class=" invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <input type="number"
                                    ...
                                    value="{{ old('percentage') }}" max="100" min="1">
                                @error('percentage')
                                <span class=" invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <textarea type="text"
                                    ...
                                    name="description" required autocomplete="Description" id="Description"
                                    aria-describedby="Description" placeholder="Create your Description"

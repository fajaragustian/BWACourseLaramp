...
@section('title','Dashboard New Camps ')
@section('content')
<!-- Page Heading -->
    ...
    <div class="col-lg-12 mb-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">New Camps</h6>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4 pt-md-2">
                        <img src="{{ asset('assets/images/banner.png') }}" class="img-profile mx-auto d-block" srcset=""
                            width="320px" height="240px" title="profile">
                    </div>
                    <div class="col-md-8 ">
                        <form class="user" method="POST" action="{{ route('camps.store') }}"
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Create Your Title Camps" value="{{ old('title') }}">
                                @error('title')
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Create Your Price Camps" value="{{ old('price') }}">
                                @error('price')
                                <span class=" invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <select name="level" class="form-control @error('level') is-invalid @enderror"
                                    id="level">
                                    <option value="Basic" {{ old('level')=='Basic' ? 'selected' : '' }}>Basic
                                    </option>
                                    <option value="Proficient" {{ old('level')=='Proficient' ? 'selected' : '' }}>
                                        Proficient
                                    </option>
                            ...
                            <div class=" form-group">
                                ...
                                <textarea type="text" class="form-control  @error('desc') is-invalid @enderror"
                                    ...
                                    placeholder="Create Your Description Camps">{{ old('desc') }}</textarea>
                                @error('desc')
                                <span class=" invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

                        ...
                        <form class="user" action="{{ route('users.update', $user->id) }}" method="POST"
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Enter Your Working" value="{{ $user->working ?? old('working') }}">
                                @error('working')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Enter Your Country" value="{{ $user->country ?? old('country') }}">
                                @error('country')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <input type="text"
                                    ...
                                    placeholder="Enter Your Region" value="{{  $user->region ?? old('region') }}">
                                @error('region')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class=" form-group">
                                ...
                                <input type="password"
                                    ...
                                    name="confirm-password" id="confirm-password" aria-describedby="confirm-password"
                            ...
                            {{-- Photos --}}
                            <div class="form-group">
                                <label for="avatar" class="form-label ml-2">Upload Photos</label>
                            ...
                            <div class=" form-group">
                                <label for="roles[]"
                                    class="form-label ml-2 @error('roles[]') is-invalid @enderror">Select Role</label>
                                <select class="form-control multiple" multiple name="roles[]" id="roles[]" size="3">
